...
var rootCmd = &cobra.Command{
	Use:     "unified-logging-coord",
	Short:   "Unified Logging Management Cluster component",
	Long:    `Unified Logging component on Management Cluster executes queries against Application Clusters`,
