...
var rootCmd = &cobra.Command{
	Use:   "unified-logging-slave",
	Short: "Unified Logging Application Cluster component",
	Long:  `Unified Logging component on Application Cluster executes queries against local Elastic`,
